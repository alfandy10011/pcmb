...
<!<link href="<?php echo base_url(); ?>assetsatu/bootstrep_3_2_0/css/bootstrap.css" rel="stylesheet">



<link rel="shortcut icon" href="<?php echo base_url(); ?>asset/img/ungu.png" type="image/x-icon">
<link rel="icon" href="<?php echo base_url(); ?>asset/img/ungu.png" type="image/x-icon">
  ...
  <body onLoad="goforit()">
    ...
    <div class="navbar navbar-inverse">
      <div class="navbar-inner">
        ...
        <?php echo $this->load->view('navbar');?>
          ...
          <span class="span6" style="padding:px 2px; color:#fff;">
   ...
   <div class="navbar navbar-inverse">
        ...
        <div class="alert alert-info">
          ...
          <img src="<?php echo base_url();?>asset/img/poligon_icon.png" width="72" height="52" style="padding:7px;">
          </div>
